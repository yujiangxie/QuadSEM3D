...
! for acoustic solver
  !lucas, to update potential_dot_dot_acoustic
...
! forward simulationssource_adjoint
    ...
    do isource = 1,NSOURCES
      ...
      if (myrank == islice_selected_source(isource)) then
        ...
        if (ispec_is_acoustic(ispec)) then
          ...
          stf = get_stf_acoustic(time_source_dble,isource)! lucas, ! returns source time function value for specified time
          ...
          ! beware, for acoustic medium, source is: pressure divided by Kappa of the fluid, lucas, p/k
            ...
            do j=1,NGLLY
              do i=1,NGLLX
                ...
                potential_dot_dot_acoustic(iglob) = potential_dot_dot_acoustic(iglob) &
                        - sourcearrays(isource,1,i,j,k) * stf_used / kappastore(i,j,k,ispec)!lucas, allocate in setup_sources_receivers.f90, sourcearrays(NSOURCES,NDIM,NGLLX,NGLLY,NGLLZ)
              enddo
            enddo
          enddo
      ...
      if (ibool_read_adj_arrays .and. .not. INVERSE_FWI_FULL_PROBLEM) then
        ...
        if (.not. SU_FORMAT) then
          ...
          do irec_local = 1, nrec_local
            ...
            call compute_arrays_adjoint_source(adj_source_file,irec)! !lucas, to get source_adjoint(icomp,irec_local,itime-it_start+1)
                ...
                do j = 1,NGLLY
                  do i = 1,NGLLX
                    ...
                    potential_dot_dot_acoustic(iglob) = potential_dot_dot_acoustic(iglob) &
                                ...
                                hxir_store(irec_local,i)*hetar_store(irec_local,j)*hgammar_store(irec_local,k)!lucas, allocate in setup_sources_receivers,     
                                                                                                              !lucas, source_adjoint(NDIM,nadj_rec_local,NTSTEP_BETWEEN_READ_ADJSRC)
                  enddo
                enddo
              enddo
            endif
