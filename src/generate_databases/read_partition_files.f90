...
! added poroelastic properties and filled with 0 the last 10 entries for elastic/acoustic
  ...
  allocate(undef_mat_prop(7,nundefMat_ext_mesh),stat=ier) ! CTD_SEM
  ...
  do imat = 1, nundefMat_ext_mesh
     ...
     read(IIN) undef_mat_prop(1,imat),undef_mat_prop(2,imat),undef_mat_prop(3,imat),undef_mat_prop(4,imat), &
               undef_mat_prop(5,imat),undef_mat_prop(6,imat),undef_mat_prop(7,imat) !lucas, CTD_SEM,where undef_mat_prop(7,imat) save for tomo_m2
  enddo
...
! element indexing
  ...
  do ispec = 1, nelmnts_ext_mesh
     ! format:
     ! # ispec_local # material_index_1 # material_index_2 # corner_id1 # corner_id2 # ... # corner_id8 !!! lucas, material_index_1 =imaterial_id, material_index_2=imaterial_def.
     ! or
