...
!=====================================================================
  ...
  use shared_parameters !lucas, includes shared_input_parameters and shared_compute_parameters
...
! for model density, kappa, mu
  ...
  real(kind=CUSTOM_REAL), dimension(:,:,:,:), allocatable :: rhostore_m2,kappastore_m2,mustore_m2 !CTD_SEM
...
! mass matrix contributions
  ...
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: rmassx_m2,rmassy_m2,rmassz_m2 !lucas, CTD_SEM
...
! attenuation
  ...
  real(kind=CUSTOM_REAL), dimension(:,:,:,:), allocatable :: qkappa_attenuation_store_m2,qmu_attenuation_store_m2 !CTD_SEM
