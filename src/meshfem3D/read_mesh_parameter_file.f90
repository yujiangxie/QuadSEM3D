...
!-----add by lucas start -----
if (myrank == 0) then
    write(IMAIN,*) 'lucas test the long/lat min and max:'
    write(IMAIN,*)
    write(IMAIN,*)
    write(IMAIN,*) 'long min = ',LONGITUDE_MIN
    write(IMAIN,*) 'long max = ',LONGITUDE_MAX
    write(IMAIN,*)
    write(IMAIN,*) 'lat min = ',LATITUDE_MIN
    write(IMAIN,*) 'lat max = ',LATITUDE_MAX
    write(IMAIN,*)
    call flush_IMAIN()
  endif
!----add by lucas end------
