...
! holds input parameters given in DATA/Par_file
  ...
  ! CTD_SEM, compute full Hessian and approx Hessian kerenls
  logical :: CTD_SEM
  logical :: compute_approx_Hessian
  ...
  !CTD_SEM, compute full Hessian and approx Hessian kerenls
  character(len=MAX_STRING_LEN) :: TOMOGRAPHY_PATH_m2,TOMOGRAPHY_PATH_new_m2
  ...
  double precision :: MIN_ATTENUATION_PERIOD_m2,MAX_ATTENUATION_PERIOD_m2 ! CTD_SEM
