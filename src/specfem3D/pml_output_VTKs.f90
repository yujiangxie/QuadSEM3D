...
subroutine pml_output_VTKs()
  ...
  call write_VTK_data_elem_i(NSPEC_AB,NGLOB_AB,xstore,ystore,zstore,ibool,temp_CPML_regions,vtkfilename)!lucas, where temp_CPML_regions=elem_flag in subrontine.
