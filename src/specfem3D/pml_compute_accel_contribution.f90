...
!=====================================================================
!
!lucas, to get potential_dot_dot_acoustic_CPML(i,j,k)
    ...
    do j=1,NGLLY
      do i=1,NGLLX
        ...
        call l_parameter_computation(deltat, &
               ...
               coef0_x, coef1_x, coef2_x, &
               coef0_y, coef1_y, coef2_y, &
               coef0_z, coef1_z, coef2_z)!lucas, to get A_0, A_1, A_2, A_3, A_4, A_5, and their after coeff
...
!=====================================================================
!
!lucas, save potential_acoustic, potential_dot_acoustic, potential_dot_dot_acoustic for backforward simulation
subroutine save_potential_on_pml_interface(potential_acoustic,potential_dot_acoustic,potential_dot_dot_acoustic, & 
                                           nglob_interface_PML_acoustic,b_PML_potential,b_reclen_PML_potential) !lucas,   out: b_PML_potential, 
                                                                                                                !lucas,   the others are input
                                                                                                                !lucas,   filesize=b_reclen_PML_potential=nglob_interface_PML_acoustic 
  ...
  do iglob = 1, nglob_interface_PML_acoustic !lucas, nglob_interface_PML_acoustic stores all GLL points of all the interfaces.
...
subroutine read_potential_on_pml_interface(b_potential_dot_dot_acoustic,b_potential_dot_acoustic,b_potential_acoustic, &
                                           nglob_interface_PML_acoustic,b_PML_potential,b_reclen_PML_potential) ! lucas, the first three are output, and the last three are input
  ...
  call read_abs(1,b_PML_potential,b_reclen_PML_potential,NSTEP-it+1)! lucas, to get b_PML_potential
...
!=====================================================================
!
!lucas, to get A0 and their after coeff
