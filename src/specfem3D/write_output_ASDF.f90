...
!! \param iorientation The recorded seismogram's orientation direction
  subroutine store_asdf_data(seismogram_tmp, irec_local, irec, chn, iorientation)! call store_asdf_data(one_seismogram,irec_local,irec,channel,iorientation)
  ...
  index_increment = iorientation !lucas, where iorientation=1,2,3 or =1 (pressure)
